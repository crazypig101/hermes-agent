...
<!-- Sourced from Letta agent agent-5a8a6339-6a34-4e5c-a5c8-bf2781c148ab on 20260511T194819Z -->

# LETTA-CANONICAL TOOL SURFACE

Total tools attached on Letta server: **58**
...
- **`gungnir_precision_entry`** — Compute precision entry score using multi-indicator confluence.  Checks candlestick patterns, Bollinger Bands, volume, support/resistance, RSI.
